...
export interface AuthResult {
  ...
  role: Role
  /**
   * Cookie-bound client carrying the caller's session — queries run under
   * RLS as the user. API routes must use this instead of the session-less
   * anon singleton in lib/supabase.ts.
   */
